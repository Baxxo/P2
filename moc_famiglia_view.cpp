...
void Famiglia_View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Famiglia_View *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Famiglia_View::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Famiglia_View.data,
    qt_meta_data_Famiglia_View,
    qt_static_metacall,
    nullptr,
    nullptr
} };
